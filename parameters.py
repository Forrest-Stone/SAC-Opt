...
Your task is to identify and extract parameters from the description. The parameters are only explictly mentioned values that are already known. Please generate the output in the following format:
